...
## Conclusion
Client-side platforms can provide high-level delightful functionalities while still exposing internal layers for power. I think the most important guidelines for building a system that's intentionally leaky are **to have a point of view**, never hiding **properties related to performance or operations**, and exposing layers of abstractions with **reflexive features**.
